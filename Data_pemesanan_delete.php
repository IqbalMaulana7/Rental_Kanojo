...
<div class="jaraks">
<input class="btn btn-success" type="submit" value="Delete" name="proses"></input>
...
?><?php
$nama = $_POST['nama'];
$encrypted_nama = encrypt($nama);
mysqli_query($konek,"DELETE FROM pemesanan WHERE nama = '$encrypted_nama'");
    
    echo "<p style='text-align:center; color:red;'>Pemesanan telah terhapus. Silahkan refresh page.</p>";?>
<?php
}
?>
