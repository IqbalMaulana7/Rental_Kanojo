...
<div class="crud">
  <form action="" method="post">
    <b><a>Edit Keterangan Kanojo</a><b>
  <input class="form-control" type="text" name="nama" placeholder="Nama"/>
  <input class="form-control" type="text" name="keterangan" placeholder="Keterangan"/>
<div class="jaraks">
<input class="btn btn-success" type="submit" value="Edit" name="proses"></input>
...
?><?php
    $encrypted_nama = substitusi_encryption($nama, $sub_table);
    $encrypted_keterangan = substitusi_encryption($keterangan, $sub_table);

    mysqli_query($konek,"update talent set
    keterangan = '$encrypted_keterangan'
    where nama = '$encrypted_nama';
    ");
