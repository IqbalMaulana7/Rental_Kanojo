...
<div class="crud">
  ...
  <div class="jaraks">
    <input class="btn btn-danger" type="submit" value="Delete" name="proses"></input>
</div>
            </div>
</form>
...
if(isset($_POST['proses'])){
  $nama = $_POST['nama'];
?><?php
    mysqli_query($konek,"delete from talent where
    nama = '$nama'
    ");
    echo "<p style='text-align:center; color:red;'>Talent telah terhapus. Silahkan refresh page.</p>";?>
<?php
}
?>
