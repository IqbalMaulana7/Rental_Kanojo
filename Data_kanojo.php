...
if (isset($_POST['download'])) {
  ...
  foreach ($row as &$data) {
      $data['lahir'] = substitusi_decryption($data['lahir'],$sub_table);
      $data['hobi'] = substitusi_decryption($data['hobi'],$sub_table);
      $data['keterangan'] = substitusi_decryption($data['keterangan'],$sub_table);
  }
...
<div class="crud">
    <a href="Data_kanojo_tambah.php"><button type="button" class="btn btn-success" >Tambah</button></a>
    <a href="Data_kanojo_edit.php"><button type="button" class="btn btn-warning">Edit</button></a>
    <a href="Data_kanojo_delete.php"><button type="button" class="btn btn-danger">Delete</button></a>
    <form method="POST" >
